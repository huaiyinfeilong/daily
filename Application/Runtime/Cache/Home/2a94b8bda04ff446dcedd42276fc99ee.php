...
<div class="wrap">
    ...
    <div class="main">
        ...
        <!-- 日报列表结束 -->
        <!-- 日报内容开始 -->
        <div class="daily-detail-view" style="display:none;">
